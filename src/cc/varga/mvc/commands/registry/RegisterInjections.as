...
package cc.varga.mvc.commands.registry
{
	...
	public class RegisterInjections extends Command
	{
		public function RegisterInjections()
		{
			super();
		}
		...
		override public function execute() : void{
			...
			Logger.tracing("Register Injections", this.toString());
		...
		public function toString():String{ return "cc.varga.mvc.commands.registry.RegisterInjections"}
	}
