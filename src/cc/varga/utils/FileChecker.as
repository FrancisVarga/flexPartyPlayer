...
package cc.varga.utils
{
	public class FileChecker
	{
		...
		public static function checkFileType(jsonObj : Object):String{
			
			var content_type : String = jsonObj["_attachments"]["audio/" + json]
			
			return "";
			
		}
		
		public function toString():String{ return "cc.varga.utils.FileChecker"}
	}
